...
import { Flower2, Mail, Phone, MapPin, Facebook, Twitter, Instagram, Linkedin, Sparkles, Heart, Award, Clock } from "lucide-react";
  ...
  return (
    <footer className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        ...
        <div className="absolute top-40 right-20 w-24 h-24 bg-gradient-gold rounded-full animate-float" style={{ animationDelay: '2s' }} />
        <div className="absolute bottom-20 left-1/4 w-16 h-16 bg-gradient-sunset rounded-full animate-float" style={{ animationDelay: '4s' }} />
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-300 leading-relaxed">
                Professional decoration services for all occasions. Making your celebrations memorable with beautiful decorations and creative designs.
              </p>
              ...
              <div className="flex space-x-4">
                <Button variant="ghost" size="sm" className="w-10 h-10 p-0 rounded-xl bg-white/10 hover:bg-white/20 text-white border-white/20">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <Link to="/" className="block text-gray-300 hover:text-white transition-colors duration-300 group">
                ...
                <Link to="/services" className="block text-gray-300 hover:text-white transition-colors duration-300 group">
                  <span className="flex items-center">
                    <div className="w-1 h-1 bg-gradient-primary rounded-full mr-3 group-hover:scale-150 transition-transform duration-300" />
                    Services
                  </span>
                </Link>
                <Link to="/gallery" className="block text-gray-300 hover:text-white transition-colors duration-300 group">
                  <span className="flex items-center">
                    <div className="w-1 h-1 bg-gradient-primary rounded-full mr-3 group-hover:scale-150 transition-transform duration-300" />
                    Gallery
                  </span>
                </Link>
                <Link to="/about" className="block text-gray-300 hover:text-white transition-colors duration-300 group">
                  <span className="flex items-center">
                    <div className="w-1 h-1 bg-gradient-primary rounded-full mr-3 group-hover:scale-150 transition-transform duration-300" />
                    About Us
                  </span>
                </Link>
                <Link to="/contact" className="block text-gray-300 hover:text-white transition-colors duration-300 group">
                  <span className="flex items-center">
                    <div className="w-1 h-1 bg-gradient-primary rounded-full mr-3 group-hover:scale-150 transition-transform duration-300" />
                    Contact
                  </span>
            ...
            <div className="space-y-6">
              ...
              <div className="pt-4">
                ...
                <div className="flex space-x-2">
                  ...
                  />
                  <Button size="sm" className="bg-gradient-primary hover:shadow-glow text-white px-4 py-2 rounded-lg">
          ...
          <div className="container mx-auto px-4 py-6">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              <div className="flex items-center space-x-4 text-gray-400 text-sm">
                <span>© {currentYear} Shree Ganesh Decoration. All rights reserved.</span>
